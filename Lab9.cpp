...
//
//////////Q1)   There are two classes account and atm
//////////Q2)   use cases for account -CheckMoney,addToMoney,SubtractFromMoney,PwdCompare,BankStatementGenerator
/////////////	use cases for atm -Transfer Money, WithDraw Money, Pay Bills, PrintBank Statement
